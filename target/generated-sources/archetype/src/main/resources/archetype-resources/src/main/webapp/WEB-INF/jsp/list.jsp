		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${symbol_dollar}{toDos}" var="t">
						<tr>
							<td>${symbol_dollar}{t.id}</td>
							<td>${symbol_dollar}{t.name}</td>
							<td>${symbol_dollar}{t.date}</td>
							<td><a class="btn btn-default" href="delete.do?id=${symbol_dollar}{t.id}">Delete</a></td>
						</tr>
					</c:forEach>
				</table>
